...
from .views import Register, loginView, LogoutView, UserDetailView, UserListView,DashboardView, MyPageView, user_info, search, quiz_history
...
urlpatterns = [
    ...
    path('user_info/<int:pk>/', user_info, name='user_info'),
